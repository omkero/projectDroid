...
import com.example.projectdroid.components.DisplayPool
import com.example.projectdroid.components.SetStatusBarContentColor
import com.example.projectdroid.repo.fetchAntminerDataLoop
import com.example.projectdroid.repo.fetchAntminerDataOnce
...
import com.example.projectdroid.utils.UptimeToDate
...
fun MinerDetailsScreen(context: Context, navController: NavHostController, minerIndex: Int) {
    ...
    var uptimeUnix by remember { mutableIntStateOf(0) }
